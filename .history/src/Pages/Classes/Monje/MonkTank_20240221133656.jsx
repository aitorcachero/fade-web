    ...
    <div className="w-full flex flex-col justify-center items-center gap-2  mb-10">
      <article className="border border-orange-500 rounded-lg  relative p-10 flex  items-center shadow-md shadow-orange-800  mb-24 bg-slate-950  flex-col justify-center gap-2">
        ...
        <p className="w-2/4 mb-10 text-center">
          ...
          aumenta tu tiempo de actividad de{' '}
          <strong className="font-bold text-orange-500">brebaje evasivo</strong>
          . El equipo de evasión es el que más reduce el daño total recibido,
          pero no es muy fiable y te hace vulnerable a picos de daño
          impredecibles. Es más adecuado para raids de 10 jugadores.
        </p>
