...
export default function MonkTank() {
  return (
    <div className="w-full flex flex-col justify-center items-center gap-2  mb-10">
      <article className="border border-orange-500 rounded-lg  relative p-10 flex flex-row justify-between items-center shadow-md shadow-orange-800  mb-24 bg-slate-950 flex flex-col justify-center items-center gap-2">
        ...
        <p className="w-2/4 mb-10 text-center">
          Esta prioridad hace hincapié en el índice de golpe crítico, que
          aumenta tu tiempo de actividad de Icono de brebaje evasivo. El equipo
          de evasión es el que más reduce el daño total recibido, pero no es muy
          fiable y te hace vulnerable a picos de daño impredecibles. Es más
          adecuado para raids de 10 jugadores.
        </p>
