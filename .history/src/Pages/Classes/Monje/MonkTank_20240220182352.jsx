...
export default function MonkTank() {
  return (
    <div className="w-full flex flex-col justify-center items-center gap-2  mb-10">
      <article className="border border-orange-500 rounded-lg  relative p-10 flex justify-between items-center shadow-md shadow-orange-800  mb-24 bg-slate-950 flex flex-col justify-center items-center gap-2">
