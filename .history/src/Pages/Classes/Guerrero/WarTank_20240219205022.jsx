    ...
    <>
      <div className="w-full flex flex-col justify-center items-center gap-2  mb-10">
        ...
        <p>
          ...
          que tus esquivas y paradas aumenten tu golpe crítico, lo que a su vez
          aumenta tu generación de rabia (ya que los golpes críticos con{' '}
          <span className="text-orange-500 font-bold">Devastar</span> y{' '}
          <span className="text-orange-500 font-bold">Golpe de escudo</span> te
          proporcionan rabia).
        </p>
