        ...
        <article className="border border-orange-500 rounded-lg  relative p-10 flex  items-center shadow-md shadow-orange-800  mb-24 bg-slate-950  flex-col justify-center gap-2">
          <div className="flex flex-col justify-center items-center gap-2">
            ...
            <p className="w-2/4">
              ...
              <span className="text-orange-500 font-bold">Contestación</span>{' '}
              hace que tus esquivas y paradas aumenten tu golpe crítico, lo que
              a su vez aumenta tu generación de rabia (ya que los golpes
              críticos con{' '}
          ...
          <div className="flex flex-col justify-center items-center gap-2">
            ...
            <p className="w-2/4">
              Esta estrategia no tiene en cuenta ni esquivar ni parada (lo que
              se traduce en un menor número de esquivas y paradas), sino que va
