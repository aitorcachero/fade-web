...
export default function HomePage() {
  return (
    <>
      <article className="p-10 mt-24 absolute right-0 top-0 flex">
        ...
        <a href="https://discord.gg/GCrUkXe5N4">
          <button className="flex flex-row border justify-center items-center gap-10 px-20 rounded-xl bg-blue-700 text-xl mt-96 r-0 ml-64 hover:bg-green-700">
