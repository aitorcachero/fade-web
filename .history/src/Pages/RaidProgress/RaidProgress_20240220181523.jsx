...
export default function RaidProgress() {
  ...
  const getColor = (length, defeated) => {
    ...
    if (data < 100) return 'bg-orange-700';
  ...
  return (
    <>
      <div className="h-screen">
        ...
        <h2 className="gap-10 px-14 text-3xl mt-10 underline">
          Progreso de bandas
        </h2>
                  ...
                  {raid.modalidad.map((mod, i) => {
                    return (
                      ...
                      >
                        ...
                        <div className="w-52  border flex justify-center item">
                          <div
                            className="w-full  bg-gray-200 dark:bg-gray-700 relative flex items-center"
                            onMouseEnter={() => {
