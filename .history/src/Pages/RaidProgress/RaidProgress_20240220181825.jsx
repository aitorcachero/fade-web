  ...
  return (
    <>
      <div className="h-">
        {modeProgress && (
          <div
            className="flex flex-col absolute bg-gray-900 p-4 z-10 w-auto transition-all rounded opacity-90"
        ...
        <div className="w-full p-14 flex flex-col lg:flex-row gap-10 mt-10">
