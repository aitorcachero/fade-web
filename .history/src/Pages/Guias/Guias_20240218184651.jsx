  ...
  return (
    <div className="w-auto">
      <aside className="w-96 h-screen bg-slate-950  fixed mr-96">
        <ul className="flex flex-col justify-between items-center w-full pt-10 mt-20">
...
//                 onClick={() => setRaid(i)}
//               >
//                 <p className="text-lg text-orange-500">{raid.name}</p>
//               </li>
//             );
//           })}
//         </ul>
//       </aside>
//       <main className="flex w-full justify-center items-center mt-20">
//         {!raid && <img src={logo} />}
//         {raid && raid === 0 && <Msv />}
//         {raid && raid === 1 && <Hof />}
//         {raid && raid === 2 && <Toes />}
