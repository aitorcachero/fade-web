                    ...
                    >
                      ...
                      <div className="w-52 h-full border flex justify-center item">
                        ...
                        >
                          <div
                            className={`${getColor(
                              mod?.modalidad.defeated.length,
                              mod?.modalidad.defeated.reduce((v, a) => v + a, 0)
                            )} h-full`}
                            style={{
                              width: `${calcWidth(
                                mod?.modalidad.defeated.length,
                                mod?.modalidad.defeated.reduce(
                                  (v, a) => v + a,
                                  0
                                )
                              )}%`,
